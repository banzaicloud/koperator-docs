...
>We took a different approach to what's out there - we believe for a good reason - please read on to understand more about our [design motivations](overview/features/) and some of the [scenarios](overview/scenarios/) which were driving us to create the Banzai Cloud Kafka operator.
